...
final class GeneratedConfig
{
  ...
  array (
    'install_path' => '/usr/local/src/environment/tools/.phpstan/vendor/ergebnis/phpstan-rules',
  ...
  array (
    'install_path' => '/usr/local/src/environment/tools/.phpstan/vendor/phpstan/phpstan-strict-rules',
  ...
  array (
    'install_path' => '/usr/local/src/environment/tools/.phpstan/vendor/tomasvotruba/type-coverage',
